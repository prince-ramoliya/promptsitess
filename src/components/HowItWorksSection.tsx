...
const steps = [
  ...
  { icon: Code2, title: 'Paste into Your AI Tool', desc: 'Open Lovable, Cursor, or Bolt and paste the prompt. The AI will understand exactly what to build.', color: 'from-[hsl(var(--cyan))]/20 to-[hsl(var(--cyan))]/5' },
  { icon: Sparkles, title: 'Generate the UI', desc: 'Watch as the AI generates a pixel-perfect recreation of the component in seconds.', color: 'from-[hsl(var(--emerald))]/20 to-[hsl(var(--emerald))]/5' },
];
