  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden bg-background">
      ...
      <div className="relative z-10 max-w-[1200px] mx-auto px-5 sm:px-6 flex flex-col items-center text-center gap-5 sm:gap-8 pt-24 sm:pt-32">
        ...
        >
          <a href="#gallery" className="glow-button gradient-text-animated flex items-center gap-2.5 text-sm w-full sm:w-auto justify-center !text-transparent">
            Browse Components <ArrowRight className="w-4 h-4 text-primary-foreground" />
          </a>
        </motion.div>
      </div>
