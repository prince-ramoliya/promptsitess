  ...
  <footer className="border-t border-border/30 bg-card/20 section-padding !py-12 relative">
    ...
    <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6 relative z-10">
      <Link to="/" className="transition-transform duration-300 hover:scale-105 active:scale-95">
        <img src={logo} alt="PromptSites" className="h-5 sm:h-6 object-contain" />
      </Link>
      ...
      <div className="flex items-center gap-4">
        <a href="https://discord.gg/UzQH2pmj" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-foreground transition-colors duration-300" title="Discord">
        ...
        <a href="https://x.com/prince_2141" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-foreground transition-colors duration-300" title="X (Twitter)">
      ...
      <div className="flex flex-col items-center gap-1">
        ...
        <p className="text-xs text-muted-foreground">Developed by <a href="https://x.com/prince_2141" target="_blank" rel="noopener noreferrer" className="text-foreground hover:text-primary transition-colors duration-300">Prince Ramoliya</a></p>
      </div>
    </div>
  </footer>
);
